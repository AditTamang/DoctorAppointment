        ...
        <form action="login" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="email" id="email" name="email" class="form-control with-icon" placeholder="admin@example.com" required>
                </div>
                <small class="text-muted">Try using admin@example.com or test@gmail.com for testing</small>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="password" id="password" name="password" class="form-control with-icon" placeholder="admin" required>
                ...
                <small class="text-muted">Password is "admin" for admin@example.com and "password" for test@gmail.com</small>
            </div>
